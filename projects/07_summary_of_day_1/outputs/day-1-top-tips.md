...
### 1. Don't ask the model to *do* the hard thing — ask it to write the code that does it
...
### 2. Give it context — don't ask cold, "one-shot" questions
...
### 3. The technology is powerful but *inhuman* — it's all just text and tokens
...
### 4. Understand the context window — and that position matters
...
### 5. Start a new chat / new task whenever you switch tasks
...
### 6. Actively manage the context — compact, fork, and watch usage
...
### 7. Pick the model to match the job
...
### 8. Mind data sensitivity — this plan is "at your own risk" for now
...
### 9. Be deliberate about what folders you give Cowork
...
### 10. Use exact file paths for reliable local work
...
### 11. Iterate by just telling Claude what's wrong
...
### 12. Keep your judgment in the loop — the model extends you, it doesn't replace you
